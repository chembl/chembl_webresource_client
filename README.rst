...
The library helps accessing ChEMBL data from Python. You don't know to write SQL. You don't need to know how to interact with REST APIs. Results are cached.
