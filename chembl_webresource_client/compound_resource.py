...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    def get_one(self, chembl_id=None, **kwargs):
        ...
        data = None
        if chembl_id:
            return super(CompoundResource, self).get_one(chembl_id=chembl_id, frmt=frmt, asyn=asyn, prop=prop)
        if 'stdinchikey' in kwargs:
            key = 'stdinchikey'
        elif 'smiles' in kwargs:
            key = 'smiles'
        ...
        return self._get_one(url, asyn, frmt, method, data)
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    def get_single_image(self, chembl_id, asyn, **kwargs):
        try:
